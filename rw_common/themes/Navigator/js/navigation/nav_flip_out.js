...
elixir.navigationEffect = (function() {
	...
	function navigationEffectFunction() {
        $('.site_navigation').prependTo('.st-pusher');
		$('#trigger_button').attr( 'data-effect', 'st-effect-14' );
		$('.site_navigation').addClass( 'st-effect-14' ).addClass('st-menu');
		$('.site_navigation').attr( 'id' , 'menu-14');
